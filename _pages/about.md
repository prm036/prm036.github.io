...
I am broadly interested in **deep learning**, **foundation models**, and **Generative AI**, particularly [diffusion models](https://en.wikipedia.org/wiki/Diffusion_model). I'm exploring these areas from both a theoretical and a systems/application perspective, focusing on developing models that are not only high-performing, but also efficient, robust, and deployable in real-world environments.
